  ...
  <nav class="rounded-b-lg font-bold flex items-center">
    <div class="flex text-sm">
      ...
      <button
        ...
        :class="{
          'o1-text-primary-500': hasPreviousPages,
      ...
      <button
        ...
        :class="{
          'o1-text-primary-500': page !== n,
          'o1-text-primary-500 o1-bg-primary-50 dark:o1-bg-primary-900': page === n,
        }"
      ...
      <button
        ...
        class="border-r border-gray-200 dark:border-gray-700 text-xl h-9 min-w-9 px-2 focus:outline-none focus:bg-gray-50 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:o1-opacity-50"
        :class="{
          'o1-text-primary-500': hasMorePages,
